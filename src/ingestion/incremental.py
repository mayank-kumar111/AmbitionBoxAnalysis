"""Incrementally merge new company snapshots without losing the baseline dataset."""
...
class IncrementalIngestor:
    """Merge cleaned snapshots using company name + location as the identity key."""
    ...
    def merge(self, incoming: pd.DataFrame, output_path: str | Path | None = None) -> tuple[pd.DataFrame, IngestionResult]:
        """Merge incoming cleaned records and return the merged frame + summary."""
        ...
        # The merge itself should never introduce invalid ratings/ages.
